  ...
  return (
    <div className={`space-y-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>
      ...
      <motion.div
        ...
        className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b pb-6 border-current/10"
      >
            ...
            <div className="relative h-72 w-full rounded-2xl overflow-hidden shadow-lg border border-white/10">
              <SeoImage
                ...
                alt={seoEngine.generateMediaAltText({
                  entityType: 'PROPERTY',
                  entityTitle: `${activePick.title} (${activePick.categoryTitle})`,
                  locality: activePick.locationName || 'Pune',
                  city: 'Pune',
