...
export const ReraComplianceCenter: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 py-4">
      ...
      {/* Statutory Registered Entity / Agent License Card */}
      <div className="p-6 rounded-3xl bg-gradient-to-r from-emerald-950/40 via-black to-[#0E1524] border border-emerald-500/40 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-[10px] font-bold font-mono tracking-wider uppercase">
              Official MahaRERA Agent Registration
            </span>
          ...
          <p className="text-xs text-white/70">
            Registered Real Estate Entity with Maharashtra Real Estate Regulatory Authority.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-black/60 p-4 rounded-2xl border border-emerald-500/30">
          <div>
            <span className="text-[10px] uppercase tracking-wider text-white/50 font-bold block">
              MahaRERA Registration Number
            </span>
            <span className="text-lg sm:text-xl font-mono font-bold text-amber-400 tracking-wider">
              A031262603640
            </span>
          </div>
          <a
          ...
          >
            <span>Verify Authority Portal</span>
